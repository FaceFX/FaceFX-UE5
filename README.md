...
The FaceFX UE5 plugin supports UE5 version 5.3. It will not work unmodified on earlier versions of UE5.
...
**Note**: The pre-built binaries distribution will only work with the version of UE5 that is installed from inside the Epic Games Launcher application (currently 5.3). If you are using the UE5 GitHub source code you need to follow the directions for building the plugin from source.

##### Windows

1. [Download](https://unreal.facefx.com) the pre-built binaries distribution.

2. Unzip the pre-built binaries distribution into your **C:\Program Files\Epic Games\UE_5.3\Engine\Plugins\Runtime** directory. You should now have this directory: **C:\Program Files\Epic Games\UE_5.3\Engine\Plugins\Runtime\FaceFX**.
...
2. Unzip the pre-built binaries distribution into your **/Users/Shared/Epic Games/UE_5.3/Engine/Plugins/Runtime** directory. You should now have this directory: **/Users/Shared/Epic Games/UE_5.3/Engine/Plugins/Runtime/FaceFX**.
